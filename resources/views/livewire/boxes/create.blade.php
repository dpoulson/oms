<div class="card">
    <div class="card-body" >
        ...
        <button x-on:click="open = ! open">Quick Add</button>
            <div x-show="open"
                ...
                <form class="w-full max-w-sm">
                    ...
                    <div class="md:flex md:items-center mb-6">
                        <div class="md:w-1/3">
                            <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="box_id">Shelf:</label>
                        </div>
                        <div class="md:w-2/3">
                            <select wire:model="shelf_id" id="shelf_id" class="border border-grey rounded-md bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500">
                                <option value="-1">Select a shelf</option>
        ...
        <div x-data="{ open: false }">
            <button x-on:click="open = ! open">Bulk Add</button>
                <div x-show="open"
                    x-transition:enter="transition ease-out duration-300"
                    x-transition:enter-start="opacity-0 scale-90"
                    x-transition:enter-end="opacity-100 scale-100"
                    ...
                    <form class="w-full max-w-sm">
                        <div class="md:flex md:items-center mb-6">
                            <div class="md:w-1/3">
                                <label for="name" class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4">Name Prefix:</label>
                            </div>
                            <div class="md:w-2/3">
                                <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 @error('name') is-invalid @enderror" id="name" placeholder="Enter Name" wire:model="name">
                                @error('name')
                        ...
                        <div class="d-grid gap-2">
                            <button wire:click.prevent="bulk()" class="btn btn-success btn-block">Create</button>
                            <button wire:click.prevent="cancel()" class="btn btn-secondary btn-block">Cancel</button>
                        </div>
                    </form>
                </div>
